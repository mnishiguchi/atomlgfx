...
Use explicit binary batches for hot drawing bursts. For MovingIcons-style
animation, keep object state in Elixir and render into caller-owned sprites or
small strip sprites before pushing completed pixels to the LCD.
