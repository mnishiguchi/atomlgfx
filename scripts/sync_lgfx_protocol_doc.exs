...
defmodule Main do
  ...
  defp run(check_mode?: check_mode?) do
    ...
    cond do
      check_mode? and updated_protocol_reference_doc_content != protocol_reference_doc_content ->
        IO.puts(
          :stderr,
      ...
      check_mode? ->
        IO.puts("Protocol reference doc generated sections are up to date.")

      updated_protocol_reference_doc_content != protocol_reference_doc_content ->
        File.write!(@protocol_reference_doc_path, updated_protocol_reference_doc_content)
        IO.puts("Updated #{@protocol_reference_doc_path}")
